...
import dev.epxzzy.epxzzysabers.platform.services.IPlatformHelper;
...
public class Services {
    ...
    public static final IPartialItemModelRenderer PartialItemModelRenderer = load(IPartialItemModelRenderer.class);
