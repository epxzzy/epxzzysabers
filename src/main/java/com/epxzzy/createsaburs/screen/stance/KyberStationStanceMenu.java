...
public class KyberStationStanceMenu extends AbstractContainerMenu {
    ...
    public KyberStationStanceMenu(int pContainerId, Inventory playerinv, final ContainerLevelAccess pAccess) {
