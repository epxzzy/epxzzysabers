...
public class SingleBladed extends Protosaber {
    ...
    public static boolean checkForSaberBlock(Entity Entityy){
        return LevelHelper.EntityBlockingWithActiveItem(Entityy, SaberItems.SINGLE_BLADED_SABER.get());
    }

    public static boolean checkForSaberEquipment(Entity Entityy, boolean Mainhand){
        return LevelHelper.EntityEquippedActiveItem(Entityy, Mainhand, SaberItems.SINGLE_BLADED_SABER.get());
    }
