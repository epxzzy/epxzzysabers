...
public class ModItems {
    ...
    public static final RegistryObject<Item> SINGLE_BLADED_SABER = items.register("single_bladed_saber", () -> new SingleBladed(new Item.Properties().rarity(RARITY_KYBER), 2, 18, -2));
    public static final RegistryObject<Item> DUAL_BLADED_SABER = items.register("dual_bladed_saber", () -> new DualBladed(new Item.Properties().rarity(RARITY_KYBER), 4, 16, -1));
