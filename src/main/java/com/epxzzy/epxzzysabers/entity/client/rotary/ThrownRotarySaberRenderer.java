...
public class ThrownRotarySaberRenderer extends EntityRenderer<ThrownRotarySaber> implements RenderLayerParent<ThrownRotarySaber, ThrownRotarySaberGuardModel<ThrownRotarySaber>> {
    public static final ResourceLocation TRIDENT_LOCATION = epxzzySabers.asResource("textures/entity/thrownrotarysaber.png");
    public static final ResourceLocation GLOWLOC = epxzzySabers.asResource("textures/entity/glowingpart.png");
