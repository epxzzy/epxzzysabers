...
import com.epxzzy.epxzzysabers.block.custom.KyberStationBlock;
...
public class SaberBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, epxzzySabers.MOD_ID);
    ...
    private static <T extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<T> block) {
        return SaberItems.items.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
    }
